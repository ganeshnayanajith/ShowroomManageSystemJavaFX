...
public class showroomImpl implements Ishowroom{
	...
	public void addShowrromExpenses(showroomExpenses showroom_expenses) {
		try {
			...
			prepareStatement.setString(5, showroom_expenses.getType());
			prepareStatement.setString(6, showroom_expenses.getDescription());
	...
	public ObservableList<showroomExpenses> getAllShowroomExpenses() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				showroom.setType(resultSet.getString(5));
				showroom.setDescription(resultSet.getString(6));
	...
	public void updateShowroomExpenses(showroomExpenses showroom_expenses) {
		try {
			...
			prepareStatement.setString(5,showroom_expenses.getType());
			prepareStatement.setString(6, showroom_expenses.getDescription());
			prepareStatement.setString(7,showroom_expenses.getShowroomExpenseId());
